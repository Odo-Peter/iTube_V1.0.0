...
const Categories = ({
  ...
  return (
    <section className="register flex flex-col justify-center items-center mt-4">
      <div className="flex flex-col w-full text-center">
        <h3 className="text-4xl font-bold mb-8">
          Choose your default <span className="text-red-600">home video</span>{' '}
          category
        </h3>
        <div className="flex items-center justify-center gap-10 mb-8 home-btn">
        ...
        <div className="flex items-center justify-center gap-10 home-btn">
        ...
        <div className="pinkish flex justify-center items-center text-lg font-mono font-bold gap-6 pt-5 opacity-80 home-choice">
        ...
        <div className="flex justify-center items-center mb-4 mt-8 pt-8 home-img-div">
          <img src={welcome} alt="welcome" className="rounded-md" />
        </div>
        <div className="mt-16 other">
          <div className="catego">
            <h3 className="text-3xl font-bold pb-2 mt-6">
