...
const Welcome = ({ useDemoUser }) => {
  ...
  return (
    <section className="flex gap-4 justify-center items-center w-full h-full px-16 overflow-hidden welcome-page">
      <div className="w-3/5 _text">
